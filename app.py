...
api_key= "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"
client= Groq(api_key=api_key)
# Set page configuration
st.set_page_config(page_title="Badshah-GPT", page_icon="crown", layout="centered")
